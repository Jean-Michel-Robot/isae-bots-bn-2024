...
TakeCherriesPerpendicular = smach.StateMachine( outcomes=['preempted', 'end'],
                                                input_keys=['nb_actions_done','cb_disp','cb_pos','next_pos', 'color','cb_arm','cherries_loaded','take_cherries_area','nb_errors','backward','park'],
...
with TakeCherriesPerpendicular:
    smach.StateMachine.add('OBS_TAKE_CHERRIES_PERPENDICULAR', 
                            ...
                            transitions={'preempted':'preempted','done':'end','disp':'DISPLACEMENT','take':'TAKE_CHERRIES_PERPENDICULAR', 'redo':'OBS_TAKE_CHERRIES_PERPENDICULAR'})
    smach.StateMachine.add('DISPLACEMENT', 
                            Displacement(), 
                            transitions={'preempted':'preempted','done':'OBS_TAKE_CHERRIES_PERPENDICULAR','redo':'DISPLACEMENT','fail':'OBS_TAKE_CHERRIES_PERPENDICULAR'})
    smach.StateMachine.add('TAKE_CHERRIES_PERPENDICULAR', 
                            TakeCherries(), 
                            transitions={'preempted':'preempted','done':'OBS_TAKE_CHERRIES_PERPENDICULAR','fail':'OBS_TAKE_CHERRIES_PERPENDICULAR'})
