...
class ObsDepositCherries(smach.State):
    """
...
with DepositCherries:
    smach.StateMachine.add('OBS_DEPOSIT_CHERRIES', 
                            ObsDepositCherries(), 
                            transitions={'preempted':'preempted','done':'end','disp':'DISPLACEMENT','deposit':'DEPOSIT_CHERRIES', 'redo':'OBS_DEPOSIT_CHERRIES'})
    smach.StateMachine.add('DISPLACEMENT', 
                            Displacement(), 
                            transitions={'preempted':'preempted','done':'OBS_DEPOSIT_CHERRIES','redo':'DISPLACEMENT','fail':'OBS_DEPOSIT_CHERRIES'})
    smach.StateMachine.add('DEPOSIT_CHERRIES', 
                            DepositBucket(), 
                            transitions={'preempted':'preempted','done':'OBS_DEPOSIT_CHERRIES','fail':'OBS_DEPOSIT_CHERRIES'})
